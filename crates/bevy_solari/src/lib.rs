...
pub mod realtime;
pub mod scene;
/// M6a (task 18): class-Lumen-style software raytraced GI (SDF voxelization +
/// software ray marching + SDF AO/soft shadows + single-bounce GI). Pure
/// compute + WGSL, no hardware RT required. Independent of M2.
pub mod sdf_gi;
