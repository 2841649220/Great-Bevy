...
impl Default for WgpuSettings {
    fn default() -> Self {
        ...
        let limits = if matches!(priority, WgpuSettingsPriority::WebGL2) {
            wgpu_types::Limits::downlevel_webgl2_defaults()
        } else {
        ...
        Self {
            ...
            power_preference,
            priority,
            features: wgpu_types::Features::TEXTURE_ADAPTER_SPECIFIC_FORMAT_FEATURES,
    ...
    pub(crate) fn create_render(
        ...
        match self {
            ...
            RenderCreation::Automatic(render_creation) => {
                ...
                // enumeration awaits); the wrapper keeps the call shape for
