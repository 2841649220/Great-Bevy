...
impl<'a> IntoBinding<'a> for &'a WgpuTextureView {
    #[inline]
    fn into_binding(self) -> BindingResource<'a> {
        BindingResource::TextureView(self)
    }
...
impl<'a> IntoBinding<'a> for &'a [&'a WgpuTextureView] {
    #[inline]
    fn into_binding(self) -> BindingResource<'a> {
...
impl<'a> IntoBinding<'a> for &'a [&'a WgpuSampler] {
    #[inline]
    fn into_binding(self) -> BindingResource<'a> {
...
impl<'a> IntoBinding<'a> for &'a [BufferBinding<'a>] {
    #[inline]
    fn into_binding(self) -> BindingResource<'a> {
